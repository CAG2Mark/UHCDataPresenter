    ...
    addItem(item) {
        ...
        if (this.items.length > this.capacity) {
            if (this.inverted) {
                ...
                this.removeAtIndex(this.items.length - 1);
            }
        }           
    }
...
function generateDeathContainer(player, attacker, key, time) {
    ...
    if (key == "death.attack.player" && players[attacker]) {
...
var deathContainer = new DataContainer(3, deathsWidth, 108, 36, false, {bottom:16, left:16});

const playersCount = 4;
var playersContainer = new DataContainer(playersCount, playersWidth, playersHeight * playersCount, playersHeight, false, {top:16, left:16});

const damageCount = 8;
var damageContainer = new DataContainer(damageCount, playersWidth, playersHeight * damageCount, playersHeight, false, {top:16, left:16*2 + playersWidth});
